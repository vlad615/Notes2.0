...
- Node.js (рекомендованная версия: 18+)
...
ёВременные токены можете запросить лично в переписке
...
Без корректного `VITE_BASE_URL` приложение ожидает существования бэкенд-API для получения/создания задач и списков.
